...
/datum/species/human/northern
	...
	specstats = list("strength" = 0, "perception" = 1, "intelligence" = -1, "constitution" = 0, "endurance" = 1, "speed" = -1, "fortune" = 1)
	specstats_f = list("strength" = -2, "perception" = 0, "intelligence" = 2, "constitution" = -2, "endurance" = -1, "speed" = 1, "fortune" = 1)
