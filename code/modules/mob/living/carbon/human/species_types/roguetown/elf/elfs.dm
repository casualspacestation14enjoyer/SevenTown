...
/datum/species/elf/snow
	...
	specstats = list("strength" = -4, "perception" = 1, "intelligence" = 2, "constitution" = -2, "endurance" = 0, "speed" = 2, "fortune" = -1)
	specstats_f = list("strength" = -6, "perception" = 1, "intelligence" = 2, "constitution" = -3, "endurance" = 0, "speed" = 2, "fortune" = -1)
